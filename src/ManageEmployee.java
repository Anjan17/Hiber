...
public class ManageEmployee {
   ...
   public static void main(String[] args) {
      ...
      Integer empID2 = ME.addEmployee("testname55555", "Das", 19000,"Chennai","4587");
      Integer empID3 = ME.addEmployee("testname66666", "Paul", 111000,"Mumbai","3536");
   ...
   public void listEmployees( ){
      ...
      try{
         ...
         for (Iterator iterator = 
            ...
            System.out.print("Extension : " + employee.getExtension());
         }
         tx.commit();
      }catch (HibernateException e) {
         if (tx!=null) tx.rollback();
